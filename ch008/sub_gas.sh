...
mpirun -np 1 /ix1/jwang/tan77/xujian/software/amber22_ori/amber22/bin/sander.MPI -O -i ../mdin/general/gas_min.in -p ch008_gaff2_gas.prmtop -c crd_gas.inpcrd   -o output_gas_min1.out -r gas_min1.rst
sleep 2
