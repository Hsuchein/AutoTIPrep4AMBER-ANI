...
mpirun -np 16 /ix1/jwang/tan77/xujian/software/amber22_ori/amber22/bin/sander.MPI -O -i ../mdin/general/wat_min1.in -p ch006_gaff2_wat.prmtop -c crd_wat.inpcrd   -o output_wat_min1.out -r wat_min1.rst
sleep 2
echo "Water Minimization 2"
mpirun -np 16 /ix1/jwang/tan77/xujian/software/amber22_ori/amber22/bin/sander.MPI -O -i ../mdin/general/wat_min2.in -p ch006_gaff2_wat.prmtop -c wat_min1.rst -o output_wat_min2.out -r wat_min2.rst
sleep 2
echo "Water cMD Simulation 1"
mpirun -np 16 /ix1/jwang/tan77/xujian/software/amber22_ori/amber22/bin/sander.MPI -O -i ../mdin/general/wat_md_1.in -p ch006_gaff2_wat.prmtop -c wat_min2.rst -o output_wat_md1.out  -r wat_md1.rst
sleep 2
echo "Water ANI-MD Simulation"
mpirun -np 16 /ix1/jwang/tan77/xujian/software/amber22/bin/sander.MPI -O -i ../mdin/general/wat_md_2.in -p ch006_gaff2_wat.prmtop -c wat_md1.rst  -o output_wat_md2.out  -r md_final_wat.rst
sleep 2
