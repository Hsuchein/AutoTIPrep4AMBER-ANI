...
def generate_slurm_script(template_path, directory, wat_top, gas_top):
    ...
    commands_wat = [
        ...
        f"mpirun -np 6 {cMD_enegies} -O -i ../mdin/general/wat_min1.in -p {wat_top} -c crd_wat.inpcrd   -o output_wat_min1.out -r wat_min1.rst",
        "sleep 2",
        "echo \"Water Minimization 2\"",
        f"mpirun -np 6 {cMD_enegies} -O -i ../mdin/general/wat_min2.in -p {wat_top} -c wat_min1.rst -o output_wat_min2.out -r wat_min2.rst",
        "sleep 2",
        "echo \"Water cMD Simulation 1\"",
        f"mpirun -np 6 {cMD_enegies} -O -i ../mdin/general/wat_md_1.in -p {wat_top} -c wat_min2.rst -o output_wat_md1.out  -r wat_md1.rst",
        "sleep 2",
        "echo \"Water ANI-MD Simulation\"",
        f"mpirun -np 6 {ANI_enegies} -O -i ../mdin/general/wat_md_2.in -p {wat_top} -c wat_md1.rst  -o output_wat_md2.out  -r md_final_wat.rst",
        "sleep 2",
        "echo \"Water Simulation 1\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s1.group",
        "sleep 2",
        "echo \"Water Simulation 2\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s2.group",
        "sleep 2",
        "echo \"Water Simulation 3\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s3.group",
        "sleep 2",
        "echo \"Water Simulation 4\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s4.group",
        "sleep 2",
        "echo \"Water Simulation 5\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s5.group",
        "sleep 2",
        "echo \"Water Simulation 6\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s6.group",
        "sleep 2",
        "echo \"Water Simulation 7\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s7.group",
        "sleep 2",
        "echo \"Water Simulation 8\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s8.group",
        "sleep 2",
        "echo \"Water Simulation 9\"",
        f"mpirun -np 6 {ANI_enegies}  -ng 2 -groupfile ./group/wat_s9.group",
        "sleep 2",
    ]
